...
import DigitalSignImg from '$lib/imgs/digitalsign.png';
import SoundScoutImg from '$lib/imgs/soundscout_logo.jpg';
import UminhoImg from '$lib/imgs/uminho.jpg';

// Your resume data
export let DATA = {
	name: 'Nuno Moreira',
	initials: 'SB',
	url: 'https://github.com/nunomz',
	...
	summary:
		"Hello! I am a 22-year-old student from Portugal with a passion for technology and a commitment to continuous learning. I hold a degree in Engineering and Management of Information Systems from the University of Minho and am currently in my final year of a master's programme in Engineering of Information Systems. Currently, I work as a systems administrator, where I gain hands-on experience and deepen my understanding of complex systems. This position has enabled me to gain a good understanding of the inner workings of the infrastructure of a tech company. Additionally, it has helped me become somewhat fluent in the Linux operating system, which I now utilise on a daily basis.",
	avatarUrl: 'https://media.licdn.com/dms/image/v2/C4D03AQEjwQlglFjzsg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1623157937342?e=1728518400&v=beta&t=4Gm_TyKk79bvKs8YDQ0A80AsiY9F6YL_GnfjX_E7z74',
	skills: [
		'Linux',
		'Docker',
		'Kubernetes',
	...
	contact: {
		...
		social: {
			...
			LinkedIn: {
				name: 'LinkedIn',
				url: 'https://www.linkedin.com/in/nuno-moreira-95b52818a/',
				// // icon: Icons.linkedin,
				icon: LinkedinSvg,
				navbar: true,
	...
	work: [
		{
			company: 'DigitalSign',
			href: 'https://digitalsign.pt',
			badges: [],
			location: 'Guimarães, Portugal',
			title: 'Systems Administrator',
			logoUrl: DigitalSignImg,
			start: 'Jan 2023',
			end: 'Now',
			description:
				'Participation in the team responsible for managing the entire infrastructure at the company, which is entirely on-premise. Including physical and virtual infrastructure management and monitoring, maintenance and configuration of firewalls, network switches and databases. This team was also responsible for tech support and helpdesk for the entire company. Finally, implemented various internal tools based on open source software like Wiki.JS, Passbolt, GitLab.'
		},
		{
			company: 'SoundScout',
			badges: [],
			...
			location: 'Remote',
			title: 'Video Editor',
			logoUrl: SoundScoutImg,
			start: 'May 2022',
			end: 'May 2024',
			description:
				'Freelance video editing for a renowned music maganize in Portugal. This was more of a passion project I worked on while attending university.'
		},
	],
	education: [
		{
			...
			degree: "Master's Degree of Engineering of Information Systems",
			logoUrl: UminhoImg,
			start: '2012',
			end: 'Now'
		},
		{
			school: 'University of Minho',
			href: 'https://www.uminho.pt',
			degree: "Bachelor's Degree of Engineering and Management of Information Systems",
			logoUrl: UminhoImg,
			start: '2019',
			end: '2022'
		},
